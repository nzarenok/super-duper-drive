...
public class CredentialTest {
    ...
    public void testCreateCredentials() throws InterruptedException {
        ...
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.com", "testusername", "testpassword"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl1.com", "testusername1", "testpassword1"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl2.com", "testusername2", "testpassword2"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl3.com", "testusername3", "testpassword3"));
    ...
    public void testCreateCredentialsEdit() throws InterruptedException {
        ...
        List<HomePageObject.CredentialInTest> credentialsToSubmit = new ArrayList<>();
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.com", "testusername", "testpassword"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.com", "testusername1", "testpassword1"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.com", "testusername2", "testpassword2"));
    ...
    public void testDeleteCredential() throws InterruptedException {
        ...
        List<HomePageObject.CredentialInTest> credentialsToSubmit = new ArrayList<>();
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl..com", "testusername", "testpassword"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.1.com", "testusername1", "testpassword1"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://testurl.2.com", "testusername2", "testpassword2"));
    ...
    private void signUpAndGoToHome(String username) {
        ...
        loginPageObject.enterUsernameAndPassword(username, "testpassword");
