...
public class NotesTest {
    ...
    public void testNoteEdited() throws InterruptedException {
        ...
        homePageObject.editNote("TestTitle", "TestText");
        Thread.sleep(1000);

        assertEquals("TestTitle", homePageObject.getFirstNoteTitle());
        assertEquals("TestText", homePageObject.getFirstNoteText());
    }
